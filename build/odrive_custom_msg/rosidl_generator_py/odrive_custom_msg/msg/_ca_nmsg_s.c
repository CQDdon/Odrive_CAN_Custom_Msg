...
bool odrive_custom_msg__msg__ca_nmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("odrive_custom_msg.msg._ca_nmsg.CANmsg", full_classname_dest, 37) == 0);
  }
  odrive_custom_msg__msg__CANmsg * ros_message = _ros_message;
  {  // frame_id
...
PyObject * odrive_custom_msg__msg__ca_nmsg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("odrive_custom_msg.msg._ca_nmsg");
