...
static const _CANmsg_type_support_symbol_names_t _CANmsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, odrive_custom_msg, msg, CANmsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, odrive_custom_msg, msg, CANmsg)),
  }
};
...
{
  return &::odrive_custom_msg::msg::rosidl_typesupport_cpp::CANmsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, odrive_custom_msg, msg, CANmsg)() {
  return get_message_type_support_handle<odrive_custom_msg::msg::CANmsg>();
}
